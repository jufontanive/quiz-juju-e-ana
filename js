...
const q2 = {
    ...
    alternativaC : "Barrinha de cereal",
    correta      : "Hamburgão",
}
...
const q3 = {
    ...
    alternativaA : "Sempre",
    alternativaB : "nunca",
    alternativaC : "Sempre pra falar mal dos outros",
...
const q7 = {
    ...
    const q8 = {
        ...
        alternativaA : "Loira",
        alternativaB : "Todas estão corretas",
    ...
    const q9 = {
        ...
        alternativaA : "Todas estão corretas",
